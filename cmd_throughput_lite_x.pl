...
# for lightweight 10Gigabit tests MTU 1500
my @pkt_size     = (1472,  1000,  600);
my @file_postfix = ("10a", "12",  "14");
#my $cmd_udpmon =" -w0 -i0.1 -e40 -x ";
# for CoralES
#my $cmd_udpmon =" -w0 -i0.1 -e40 -x -u 18020 ";
#CoralSWE
my $cmd_udpmon =" -w0 -i1 -e20 -x -u 5201";

# for 10Gigabit cf MTU 1500 and MTU 9000
#my @pkt_size     = (8972,  6000,  4000,  3000,  2200,  2000,  1472,  1000,  600);
#my @file_postfix = ("10a", "11",  "12",  "13",  "14",  "15",  "16",  "17",  "18");
#my $cmd_udpmon =" -w0 -i0.1 -e40 -x ";
...
#my @pkt_size     = (8972,  7813, 6000,  4000 );
#my @pkt_size     = (8972,  7000, 6000,  4000 );
