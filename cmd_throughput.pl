...
# 
# for 100 Mbit tests
#my @pkt_size     = (1400, 1472,  1200,  1000,  800,  600,  400,  200,  100,  50);
...
# for 10Gigabit tests
#my @pkt_size     = (8000, 8972,  7000,  6000,  5000, 4000, 3000, 2000, 1472,  1000);
...
my @file_postfix = ("10", "10a", "11",  "12",  "13", "14", "15", "16", "17", "18");
...
my $USAGE = "Usage:\t cmd_throughput.pl [opts]
        Opts:
            [-a CPU affinity]
            [-d remote host]
            [-l number of packets]
...
Example ./cmd_throughput.pl -d 140.221.220.41 -o PC1-PC2 -l 1000
";
